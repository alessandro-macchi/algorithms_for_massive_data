...
* **SON (Savasere-Omiecinski-Navathe):** Designed for parallelization, it processes data in manageable chunks with scaled local support thresholds to handle strict memory constraints.
